...
export const DMConfigSection: React.FC = () => {
  ...
  return (
    <section
      ...
      className="space-y-4 bg-white p-6 rounded-xl border border-gray-200 shadow-md"
    >
      ...
      <div className="flex flex-col gap-3">
        <label className="text-slate-700 text-sm">
          ...
          <input
            type="text"
            className="w-full mt-1 p-2 rounded-md bg-white text-slate-800 border border-gray-200 placeholder-gray-400"
            value={name}
